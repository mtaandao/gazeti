...
$td_translation_map = array(
    ...
    'RELATED ARTICLES' => __('RELATED ARTICLES', TD_THEME_NAME),   //on Gazeti 4 it was: SIMILAR ARTICLES
    'MORE FROM AUTHOR' => __('MORE FROM AUTHOR', TD_THEME_NAME),
    'VIA' => __('VIA', TD_THEME_NAME),   //on Gazeti4 it was lowercase
    'SOURCE' => __('SOURCE', TD_THEME_NAME), //on Gazeti4 it was lowercase
    'TAGS' => __('TAGS', TD_THEME_NAME),
    ...
    'LEAVE A REPLY' => __('LEAVE A REPLY', TD_THEME_NAME),  //on Gazeti4 it was lowercase
    ...
    //review
    'REVIEW OVERVIEW' => __('REVIEW OVERVIEW', TD_THEME_NAME),  //on Gazeti4 it was lowercase
    'SUMMARY' => __('SUMMARY', TD_THEME_NAME),  //on Gazeti4 it was lowercase
