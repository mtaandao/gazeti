...
class td_video_playlist_render {
	...
	private static function get_video_data($atts, $list_type) {
		...
		// When the mtaandao composer is requesting by ajax, the $postId is set by the 'postId' param
...
//            }
	        ...
	        // When the Mtaandao composer is not available, DO NOT add the css class ('td_wrapper_playlist_player_youtube' or 'td_wrapper_playlist_player_vimeo')
