...
class td_cake {
    ...
    function td_cake_panel() {
        ...
        <div class="about-wrap td-admin-wrap">
                ...
                <table class="form-table">
                    <tr valign="top">
                        ...
                        <td>
                            ...
                            <br/>
                            <div class="td-small-bottom"><a href="http://forum.mtaandao.com/how-to-find-your-envato-purchase-code/" target="_blank">Where to find your purchase code ?</a></div>
                        </td>
                    </tr>
            ...
            <div class="td-manual-activation">
                <ul>
                    <li>1. <a href="http://mtaandao.co.ke/td_cake/manual.php" target="_blank">Go to our manual activation page</a></li>
                    <li>2. Paste your unique ID there and the <a href="http://forum.mtaandao.com/how-to-find-your-envato-purchase-code/" target="_blank">envato purchase code</a></li>
                    <li>3. <a href="http://forum.mtaandao.com/wp-content/uploads/2014/09/2014-09-09_1458.png" target="_blank">Get the activation code</a> and paste it in this form</li>
                </ul>
                ...
                <form method="post" action="admin.php?page=td_cake_panel">
                    ...
                    <table class="form-table">
                        ...
                        <tr valign="top">
                            <th scope="row">Mtaandao activation key:</th>
                            <td>
                                <input style="width: 400px" type="text" name="td_key" value="<?php echo $td_key; ?>" />
                                <br/>
                                <div class="td-small-bottom">You will get this id from the <a href="http://mtaandao.co.ke/td_cake/manual.php" target="_blank">manual activation page</a></div>
                            </td>
    ...
    function td_cake_msg() {
        ...
        ?>
        <div class="error">
            <p><?php echo '<strong style="color:red"> Please activate the theme! </strong> - <a href="' . wp_nonce_url( admin_url( 'admin.php?page=td_cake_panel' ) ) . '">Click here to enter your code</a> - if this is an error please contact us at contact@mtaandao.com - <a href="http://forum.mtaandao.com/how-to-activate-the-theme/">How to activate the theme</a>'; ?></p>
        </div>
    <?php
    }
