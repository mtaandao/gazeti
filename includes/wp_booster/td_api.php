        ...
        if (!isset(self::$components_list[$id])) {
            ...
            if (($id == 'td_social_counter' or $id == 'td_block_social_counter')) {
                if (is_user_logged_in()) {
                    td_util::error('', "Please update your [Mtaandao social counter] Plugin!");
                }
                return;
            }
...
class td_api_category_template extends td_api_base {
    ...
    static function render_category_template_by_id($template_id) {
        if (class_exists($template_id)) {
            ...
            td_util::error(__FILE__, "The category template $template_id doesn't exist. Did you disable a Mtaandao plugin?");
        }
    }
...
class td_api_footer_template extends td_api_base {
    ...
    static function _helper_show_footer() {
        ...
        try {
            ...
            td_util::error(__FILE__, "td_api_footer_template::_helper_show_footer : $template_id isn't set. Did you disable a Mtaandao plugin?");  //does not stop execution
        }
...
class td_api_header_style extends td_api_base {
    ...
    static function _helper_show_header() {
        ...
        try {
            ...
            td_util::error(__FILE__, "The header style: $tds_header_style isn't set. Did you disable a Mtaandao plugin?");  //does not stop execution
        }
        ...
        if (!empty($template_path) and file_exists($template_path)) {
            ...
            td_util::error(__FILE__, "The path $template_path of the $tds_header_style header style not found. Did you disable a Mtaandao plugin?");
        }
    }
...
//        );
    ...
    static function _helper_show_single_template($template_id) {
        ...
        try {
            ...
            td_util::error(__FILE__, "The template $template_id isn't set. Did you disable a Mtaandao plugin?"); // this does not stop execution
        }
        ...
        if (!empty($template_path) and file_exists($template_path)) {
            ...
            td_util::error(__FILE__, "The path $template_path of the $template_id template not found. Did you disable a Mtaandao plugin?");  // this does not stop execution
        }
...
class td_api_top_bar_template extends td_api_base {
    ...
    static function _helper_show_top_bar() {
        ...
        try {
            ...
            td_util::error(__FILE__, "td_api_top_bar_template::_helper_show_top_bar : $template_id isn't set. Did you disable a Mtaandao plugin?");  //does not stop execution
        }
...
class td_api_text {
	private static $text_keys = array (
		...
		// *overwritten in 012 for Mtaandao composer
		...
		// *overwritten in 012
		'panel_existing_content_url' => '<a href="http://forum.mtaandao.com/existing-content/" target="_blank">read more</a>'
	);
