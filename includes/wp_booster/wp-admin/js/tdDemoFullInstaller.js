        ...
        installNextStep: function (demoId, step, onFinishCallback) {
            ...
            jQuery.ajax({
                ...
                error: function(MLHttpRequest, textStatus, errorThrown){
                    ...
                    alert('Mtaandao importer detected an error. The importer will try to recover and continue to install the demo after you click ok on this dialog.\n' +
                        '\n' +
                        'Steps to troubleshoot:\n' +
                        '- Check the permissions on your upload folder\n' +
                        '- Please make sure that WP_DEBUG is set to false in wp-config.php\n' +
                        '- Contact our support via email contact@mtaandao.com (please provide your product license key)'
                    );
