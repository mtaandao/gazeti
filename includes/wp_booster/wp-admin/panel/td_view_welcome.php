...
<div class="td-admin-wrap about-wrap">
    ...
    <div class="feature-section two-col">
        <div class="col">
	        ...
	        <?php if (TD_THEME_NAME == 'Gazeti') { ?>
		        <h3>Update from Gazeti 4:</h3>
    ...
    <div class="td-admin-box-text">
		...
		<a class="button button-primary" href="http://demo.mtaandao.com/<?php echo strtolower(TD_THEME_NAME);?>" target="_blank">View demo</a>
		<a class="button button-primary" href="http://themeforest.net/user/Mtaandao" target="_blank">Our portfolio</a>
	</div>
	-->
</div>