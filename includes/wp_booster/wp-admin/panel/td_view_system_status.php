...
//	    ));
    ...
    function td_set_mobile_theme_settings() {
	    ...
	    $mtaandao_mobile_plugin_is_active = false;
	    ...
	    if (is_plugin_active('td-mobile-plugin/td-mobile-plugin.php')) {
		    $mtaandao_mobile_plugin_is_active = true;
	    }

	    if ($mtaandao_mobile_plugin_is_active === true) {
    ...
    if (defined('TD_SPEED_BOOSTER')) {
        if (defined('TD_SPEED_BOOSTER_INCOMPATIBLE')) {
            td_system_status::add('Theme config', array(
                ...
                'tooltip' => 'SpeedBooster detected an incompatible plugin, to avoid any possible errors the plugin automatically disabled itself. For more info about this please contact us via the forum - http://forum.mtaandao.com/',
    ...
    td_system_status::add('php.ini configuration', array(
        ...
        'value' =>  ini_get('post_max_size') . '<span class="td-status-small-text"> - You cannot upload images, themes and plugins that have a size bigger than this value. To see how you can change this please check our guide <a target="_blank" href="http://forum.mtaandao.com/system-status-parameters-guide/">here</a>.</span>',
        'status' => 'info'
    ));
    ...
    if ($max_execution_time == 0 or $max_execution_time >= 60) {
        ...
        td_system_status::add('php.ini configuration', array(
            ...
            'value' =>  $max_execution_time . '<span class="td-status-small-text"> - the execution time should be bigger than 60 if you plan to use the demos. To see how you can change this please check our guide <a target="_blank" href="http://forum.mtaandao.com/system-status-parameters-guide/">here</a>.</span>',
            'status' => 'yellow'
        ));
    }
    ...
    */
    ...
    if (defined('WP_DEBUG') and WP_DEBUG === true) {
        td_system_status::add('WordPress and plugins', array(
            ...
            'value' => 'WP_DEBUG is enabled. <span class="td-status-small-text">It may display unwanted messages. To see how you can change this please check our guide <a target="_blank" href="http://forum.mtaandao.com/system-status-parameters-guide/">here</a>.</span>',
            'status' => 'yellow'
        ));
    } else {
        td_system_status::add('WordPress and plugins', array(
    ...
    $caching_plugin_list = array(
        'wp-super-cache/wp-cache.php' => array(
            'name' => 'WP super cache - <span class="td-status-small-text">for best performance please check the plugin configuration guide <a target="_blank" href="http://forum.mtaandao.com/cache-plugin-install-and-configure/">here</a>.</span>',
            'status' => 'green',
        ),
