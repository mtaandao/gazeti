            ...
            <p>
                ...
                <?php td_util::tooltip_html('
                        ...
                        <ul>
                            ...
                            <li>For advanced users who want to customize the category header, here is the <a target="_blank" href="http://forum.mtaandao.com/api-category-top-section-template-introduction/">API documentation</a></li>
            ...
            <p>
                ...
                <?php td_util::tooltip_html('
                        ...
                        <ul>
                            ...
                            <li>For advanced users, here is the <a target="_blank" href="http://forum.mtaandao.com/api-category-top-section-style-introduction/">API documentation</a></li>
                        </ul>
                ', 'right')?>
            </p>
        </div>
...
<div class="td-box-section-separator"></div>
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            ...
            <p>Select a module type, this is how your article list will be displayed. For custom modules or tuning, read <a target="_blank" href="http://forum.mtaandao.com/api-modules-introduction/">the module API</a></p>
        </div>
