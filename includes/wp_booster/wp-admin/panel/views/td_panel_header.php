...
<?php echo td_panel_generator::box_start('Top Bar', false); ?>
    ...
    <div class="td-box-row">
        <div class="td-box-description td-box-full">
            ...
            If you are an advanced user and want to customize it or register new top bar layouts, have a look at our <a target="_blank" href="http://forum.mtaandao.com/api-top-bar-template-introduction/">top bar template API</a>
            </p>
        </div>
...
<?php echo td_panel_generator::box_start('Main Menu', false); ?>
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            ...
            <p>Preload content for all mega menus. This provides a better user experience but with a performance hit - <a href="http://forum.mtaandao.com/what-is-ajax-preloading/" target="_blank">read more</a></p>
        </div>
        <div class="td-box-control-full">
            <?php
            echo td_panel_generator::radio_button_control(array(
