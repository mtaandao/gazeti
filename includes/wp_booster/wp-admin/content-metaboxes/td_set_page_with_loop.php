        ...
        <div class="td-meta-box-row">
            <span class="td-page-o-custom-label">
                ...
                td_util::tooltip_html('
                        ...
                        <ul>
                            <li>If you want to make you own modules, please go to our <a href="http://forum.mtaandao.com/api-modules-introduction/" target="_blank">API section</a> of the documentation</li>
                        </ul>
                    ', 'right')
                ?>
            </span>
