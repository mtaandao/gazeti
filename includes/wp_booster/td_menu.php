...
class td_mtaandao_walker_nav_menu extends Walker_Nav_Menu {
    function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        //mtaandao - megamenu disable link from from includes/wp_booster/td_menu.php  hook_wp_nav_menu_objects
        ...
        //mtaandao - megamenu disable link from includes/wp_booster/td_menu.php   hook_wp_nav_menu_objects
        if ($item->is_mega_menu == false) {
            $item_output .= '</a>';
        }
