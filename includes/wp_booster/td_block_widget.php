...
class td_block_widget extends WP_Widget {
	...
	function __construct() {
	    ...
	    $widget_ops = array('classname' => 'td_pb_widget', 'description' => '[Mtaandao] ' . $this->map_array['name']);
		...
		*/
	    ...
	    $name = '[Mtaandao] ' . $this->map_array['name'];
	        ...
	        foreach ($this->map_array['params'] as $param) {
	            switch ($param['type']) {
	                ...
	                case 'textfield':
	                    ...
	                    // suggested at: http://forum.mtaandao.com/topic/please-add-block-title-to-backend-widget-title/#post-58087
