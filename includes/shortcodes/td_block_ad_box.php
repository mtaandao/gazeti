...
class td_block_ad_box extends td_block {
    ...
    function render($atts, $content = null) {
	    ...
	    // For Mtaandao composer add a placeholder element
	    if (td_util::tdc_is_live_editor_iframe() or td_util::tdc_is_live_editor_ajax()) {
		    // 'td_block_wrap' is to identify a Mtaandao composer element at binding
     ...
     */
    // Mtaandao google responsive renderer
    // copyright 2014 Mtaandao
