...
/*  ----------------------------------------------------------------------------
    footer text
 */
td_demo_misc::update_footer_text('Gazeti offers a first look at the season’s collections and trends including insightful reviews, full collection slideshows, backstage beauty, and street style.');
...
$demo_cat_9_id =td_demo_category::add_category(array(
    ...
    'top_posts_style' => 'td_category_top_posts_style_5',
    'description' => 'Check out the latest beauty news, tips, trends and ideas from around the world only on Gazeti Fashion!',
