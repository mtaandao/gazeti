...
echo td_panel_generator::box_start('Header ad', false);?>
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            ...
            <p>Paste your ad code here. Google adsense will be made responsive automatically. <br><br> To add non adsense responsive ads, <br> <a target="_blank" href="http://forum.mtaandao.com/using-other-ads/">click here</a></p>
        </div>
    ...
    <div class="td-box-row">
        <div class="td-box-description td-box-full">
            ...
            <p>If you leave the AdSense size boxes on Auto, the theme will automatically resize the <strong>google ads</strong>. For more info follow this <a href="http://forum.mtaandao.com/header-ad/" target="_blank">link</a></p>
        </div>
   ...
   <div class="td-box-row">
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            ...
            <p>Paste your ad code here. Google adsense will be made responsive automatically. <br><br> To add non adsense responsive ads, <br> <a target="_blank" href="http://forum.mtaandao.com/using-other-ads/">click here</a> (last paragraph)</p>
        </div>
        <div class="td-box-control-full">
            <?php
            echo td_panel_generator::textarea(array(
