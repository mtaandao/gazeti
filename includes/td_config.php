...
define("TD_THEME_NAME", "Gazeti");
define("TD_THEME_VERSION", "7.4");
define("TD_THEME_DEMO_URL", "http://demo.mtaandao.com/" . strtolower(TD_THEME_NAME));
define("TD_THEME_DEMO_DOC_URL", 'http://forum.mtaandao.com/demos_introduction/');  //the url to the demo documentation
    ...
    static function on_td_global_after_config() {
        ...
        td_api_thumb::add('td_80x60',
            array(
                ...
                'used_on' => array(
                    'Module MX2', 'Block 18, 19', 'Live search', 'Mtaandao Image Gallery thumbs'
                )
            )
        );
	    ...
	    td_global::$demo_list = array (
		    'default' => array(
			    ...
			    'demo_url' => 'http://demo.mtaandao.com/newspaper/',
            ...
            'black' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_black/',
            ...
            'magazine' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_magazine/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
                'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'recipes' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_recipes/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
                'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'medicine' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_medicine/',
            ...
            'what' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_what/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
                'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'blog_travel' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_blog_travel/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
                'uses_custom_style_css' => true,                // load a custom demo_style.less - must also be added to td_less_style.css.php
                'demo_installed_text' => '<a href="http://forum.mtaandao.com/import-revolution-sliders-on-demos/" target="_blank">Import revolution slider</a>'
            ),
            'blog_baby' => array(
                'text' => 'Baby Blog',
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_blog_baby/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
                'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'blog_health' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_blog_health/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
                'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'blog_cars' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_blog_cars/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
                'uses_custom_style_css' => true,                // load a custom demo_style.less - must also be added to td_less_style.css.php
                'demo_installed_text' => '<a href="http://forum.mtaandao.com/import-revolution-sliders-on-demos/" target="_blank">Import revolution slider</a>'
            ),
            'blog' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_classic_blog/',
                'td_css_generator_demo' => false,                // must have a td_css_generator_demo.php in demo's folder
                'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'animals' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_animals/',
                'td_css_generator_demo' => false,                // must have a td_css_generator_demo.php in demo's folder
		   		  'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'wedding' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_wedding/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
		   		  'uses_custom_style_css' => true,                // load a custom demo_style.less - must also be added to td_less_style.css.php
	              'demo_installed_text' => '<a href="http://forum.mtaandao.com/import-revolution-sliders-on-demos/" target="_blank">Import revolution slider</a>'
            ),
            'politics' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_politics/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
		   		  'uses_custom_style_css' => true,                // load a custom demo_style.less - must also be added to td_less_style.css.php
                'demo_installed_text' => '<a href="http://forum.mtaandao.com/import-revolution-sliders-on-demos/" target="_blank">Import revolution slider</a>'
            ),
            'college' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_college/',
                'td_css_generator_demo' => false,                // must have a td_css_generator_demo.php in demo's folder
		   		  'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'local_news' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_local_news/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
		   		  'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'cafe' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_cafe/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
		   		  'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
            'cars' => array(
                ...
                'demo_url' => 'http://demo.mtaandao.com/newspaper_cars/',
                'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
	            'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
            ),
		    'travel' => array(
			    ...
			    'demo_url' => 'http://demo.mtaandao.com/newspaper_travel/',
			    'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
			    'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
		    ),
		    'health' => array(
			    ...
			    'demo_url' => 'http://demo.mtaandao.com/newspaper_health/',
			    'td_css_generator_demo' => true,                // must have a td_css_generator_demo.php in demo's folder
			    'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
		    ),
		    'tech' => array(
			    ...
			    'demo_url' => 'http://demo.mtaandao.com/newspaper_tech/',
			    'td_css_generator_demo' => false,                // must have a td_css_generator_demo.php in demo's folder
			    'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
		    ),
		    'sport' => array(
			    ...
			    'demo_url' => 'http://demo.mtaandao.com/newspaper_sport/',
			    'td_css_generator_demo' => false,                // must have a td_css_generator_demo.php in demo's folder
			    'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
		    ),
		    'fashion' => array(
			    ...
			    'demo_url' => 'http://demo.mtaandao.com/newspaper_fashion/',
			    'td_css_generator_demo' => false,                // must have a td_css_generator_demo.php in demo's folder
			    'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
		    ),
		    'video' => array(
			    ...
			    'demo_url' => 'http://demo.mtaandao.com/newspaper_video/',
			    'td_css_generator_demo' => false,                // must have a td_css_generator_demo.php in demo's folder
			    'uses_custom_style_css' => true                // load a custom demo_style.less - must also be added to td_less_style.css.php
		    )
	    );
        ...
        if (is_admin()) {
	        ...
	        td_api_text::set('text_featured_video', '
	                ...
	                <div class="td-wpa-info"><strong>Notice:</strong> Use only with those post templates:
	                    ...
	                    <ul>
	                        <li>Find more about this <a href="http://forum.mtaandao.com/featured-image-or-video/" target="_blank">feature</a></li>
	                    </ul>
	                </div>'
	        );
            ...
            <a class="button button-primary" href="http://forum.mtaandao.com/" target="_blank">Open forum</a>'
            );
            ...
            <a class="button button-primary" href="http://forum.mtaandao.com/newspaper-theme-documentation/" target="_blank">Open documentation</a>'
            );
...
//			        ));
	        ...
	        td_global::$theme_plugins_for_info_list = array (
				array (
					...
					'text' => '<a href="http://forum.mtaandao.com/how-to-install-revolution-slider-v5/" target="_blank">How to install v5</a>',
					'required_label' => 'optional', //the text for required/recommended label - used also as a class for label bg color
					'slug' => 'revslider'
				),
		        array (
			        'name' => 'Mtaandao Mobile Theme',
			        'img' => td_global::$get_template_directory_uri . '/includes/wp_booster/wp-admin/images/plugins/mobile.png',
			        'text' => '<a href="http://forum.mtaandao.com/the-mobile-theme/" target="_blank">Read more</a>',
			        'required_label' => 'optional', //the text for required/recommended label - used also as a class for label bg color
            ...
            td_global::$theme_plugins_list = array(
                ...
                array(
                    'name' => 'Mtaandao social counter', // The plugin name
                    ...
                    'text' => '<a href="http://forum.mtaandao.com/mtaandao-social-counter-tutorial/" target="_blank">Read more</a>',
                    'required_label' => 'optional' //the text for required/recommended label - used also as a class for label bg color
                )
            );
