...
(b+=tdAffix.menu_offset));"undefined"!==typeof window.tdThemeName&&"Gazeti"===window.tdThemeName&&(b+=20);var d="";a!==tdSmartSidebar.scroll_window_scrollTop_last&&(d=a>tdSmartSidebar.scroll_window_scrollTop_last?"down":"up");tdSmartSidebar.scroll_window_scrollTop_last=a;var e=jQuery(window).height(),f=a+e;a+=b;for(var k=0;k<tdSmartSidebar.items.length;k++){var g=tdSmartSidebar.items[k];g.content_top=g.content_jquery_obj.offset().top;g.content_height=g.content_jquery_obj.height();g.content_bottom=
